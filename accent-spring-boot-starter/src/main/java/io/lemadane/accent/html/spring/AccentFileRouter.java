package io.lemadane.accent.html.spring;
...
public final class AccentFileRouter implements SmartInitializingSingleton {
    ...
    public void afterSingletonsInstantiated() {
            ...
            for (String beanName : applicationContext.getBeanDefinitionNames()) {
                try {
                    ...
                    if (!pkg.startsWith("org.springframework") && 
                        !pkg.startsWith("java") && 
                        !pkg.startsWith("io.lemadane.accent.html") &&
                        !pkg.startsWith("jdk") &&
        ...
        try {
            ...
            throw new IllegalStateException("Failed to configure Accent File-Based Routing", e);
        }
    }
    ...
    private void registerRoute(String basePackage, Class<? extends Component> pageClass) throws Exception {
        ...
        AccentRouteHandler routeHandler = new AccentRouteHandler(pageClass, findLayoutChain(basePackage, pageClass));
        Method handleMethod = AccentRouteHandler.class.getMethod("handle", Map.class, Map.class);
        ...
        System.out.println("[Accent Router] Registered file-based route: GET " + path + " -> " + className);
    }
