...
import io.lemadane.accent.lexer.*;
...
class GeneratorTest {
    ...
    void generatorReturnTypeIsIterableInEmittedJava() throws Exception {
        ...
        io.lemadane.accent.lowering.AccentLowerer lowerer = new io.lemadane.accent.lowering.AccentLowerer(new io.lemadane.accent.symbol.SymbolTable());
