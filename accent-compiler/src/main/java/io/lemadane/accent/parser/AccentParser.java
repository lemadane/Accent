package io.lemadane.accent.parser;
...
public final class AccentParser {
    ...
    public AccentParser(SourceFile sourceFile, List<Token> tokens) {
    ...
    private Expression parseInlineExpression(String exprStr, Token templateToken) {
        io.lemadane.accent.source.SourceFile file = new io.lemadane.accent.source.SourceFile(java.nio.file.Path.of("sql-inline-expression"), exprStr);
        io.lemadane.accent.lexer.AccentLexer lexer = new io.lemadane.accent.lexer.AccentLexer(file);
        io.lemadane.accent.lexer.LexResult lexResult = lexer.lex();
        ...
        AccentParser parser = new AccentParser(file, lexResult.tokens());
