package io.lemadane.accent.tools.server;

import io.lemadane.accent.ast.Ast.CompilationUnit;
import io.lemadane.accent.semantic.SemanticAnalyzer;
import io.lemadane.accent.tools.core.AccentLanguageService;
import io.lemadane.accent.tools.core.AccentLanguageService.ProjectContext;
import io.lemadane.accent.tools.core.AccentLanguageService.CompilationResult;
import io.lemadane.accent.tools.core.CompletionProvider;
import io.lemadane.accent.tools.core.HoverProvider;
import io.lemadane.accent.tools.core.DefinitionProvider;
import io.lemadane.accent.tools.core.DefinitionProvider.DefinitionLocation;
    ...
    private void triggerValidation(Path path, String uri) {
        CompletableFuture.runAsync(() -> {
            try {
                ...
                for (io.lemadane.accent.diagnostic.Diagnostic d : result.diagnostics()) {
                    DiagnosticSeverity severity = DiagnosticSeverity.Error;
                    if (d.severity() == io.lemadane.accent.diagnostic.DiagnosticSeverity.WARNING) {
                        severity = DiagnosticSeverity.Warning;
                    } else if (d.severity() == io.lemadane.accent.diagnostic.DiagnosticSeverity.INFO) {
