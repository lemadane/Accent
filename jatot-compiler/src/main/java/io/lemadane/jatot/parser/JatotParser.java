package io.lemadane.jatot.parser;
...
public final class JatotParser {
    ...
    private Expression parseInlineExpression(String exprStr, Token templateToken) {
        io.lemadane.jatot.source.SourceFile file = new io.lemadane.jatot.source.SourceFile(java.nio.file.Path.of("sql-inline-expression"), exprStr);
        io.lemadane.jatot.lexer.JatotLexer lexer = new io.lemadane.jatot.lexer.JatotLexer(file);
        io.lemadane.jatot.lexer.LexResult lexResult = lexer.lex();
